                ...
                <div class="col-sm-9" style="margin-top: 60px">
                    ...
                    <form method="POST" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="col-md-8">
                                <select name="parent_id" class="form-control">
                                    ...
                                    @foreach($root_categories as $selected_category)
                                        <option {{ isSelected($selected_category->id, $category->parent_id) }} value="{{ $selected_category->id }}">{{ $selected_category->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group required {{ $errors->has('parent_id') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                @if($category->cover)
                                    <img src="/uploads/categories/90-90-{{$category->cover}}" style="margin: 5px 0px">
                                @endif
                                <input type="file" name="category_image">
                                <input type="hidden" name="category_image_old" value="{{ $category->cover }}">
